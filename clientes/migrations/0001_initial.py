    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origem_cadastrado', models.CharField(choices=[('Advbox', 'Advbox'), ('Planilha', 'Planilha')], max_length=50, verbose_name='Origem do Cadastro')),
                ...
                ('whatsapp', models.CharField(choices=[('Sim', 'Sim'), ('Não', 'Não')], max_length=30)),
            ],
        ),
    ]
